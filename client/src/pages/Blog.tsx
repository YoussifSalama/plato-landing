            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8 mb-16">
              <div>
                ...
                <ul className="space-y-2.5">
                  ...
                  <li><Link href={localePath("/testimonials")}><span className="text-xs text-muted-foreground hover:text-foreground transition-colors" data-testid="link-blog-footer-customer-stories">{t.footerSection.customerStories}</span></Link></li>
