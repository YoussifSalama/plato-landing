        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 lg:overflow-visible">
          <ScrollReveal animation="fade-up">
            <div className="relative lg:overflow-visible">
              <div className="hidden lg:block absolute left-0 right-0 top-0 bottom-[44px] rounded-3xl bg-gradient-to-br from-[#0a3d6b] via-[#1260a0] to-[#1a7fd4]" data-testid="about-hub-panel" />
              ...
              <div className="hidden lg:flex relative z-[1] gap-0">
                ...
                <div className="flex-1 mt-[36px] mb-[-44px] dark rounded-l-2xl overflow-hidden bg-[#0d1117] shadow-2xl" style={{ marginRight: "calc(-1 * (100vw - 100%) / 2)" }} data-testid="about-analytics-dashboard">
