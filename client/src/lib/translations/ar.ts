...
إذا كانت لديك أسئلة حول هذه الشروط، يرجى التواصل معنا على hello@platohiring.com.`,
  ...
  pricingPage: {
    title: "الأسعار",
    subtitle: "أسعار بسيطة قائمة على الرصيد. ادفع فقط مقابل ما تستخدمه.",
    ...
    faqSubtitle: "كل ما تحتاج معرفته عن الأسعار والأرصدة.",
    ctaTitle: "مستعد لتبسيط",
    ctaTitleHighlight: "عملية التوظيف؟",
    ctaSubtitle: "ابدأ بتجربة مجانية واكتشف كيف يُحوّل بلاتو عملية التوظيف لديك.",
    ...
    plans: {
      starter: {
        ...
        price: "$49",
        creditsAmount: "100",
        description: "مثالي للفرق الصغيرة التي بدأت للتو مع التوظيف بالذكاء الاصطناعي.",
        features: [
          "100 رصيد شهرياً",
          "حتى 5 إعلانات وظيفية",
      ...
      growth: {
        ...
        price: "$149",
        creditsAmount: "500",
        description: "للفرق المتنامية التي تحتاج المزيد من القوة والمرونة.",
        features: [
          "500 رصيد شهرياً",
          "حتى 25 إعلان وظيفي",
          "فحص وتصنيف السير الذاتية بالذكاء الاصطناعي",
          "تواصل تلقائي مع المرشحين",
      ...
      pro: {
        ...
        price: "$349",
        creditsAmount: "1,500",
        description: "للفرق الراسخة التي توظف على نطاق واسع مع أتمتة كاملة.",
        features: [
          "1,500 رصيد شهرياً",
          "إعلانات وظيفية غير محدودة",
          "مقابلات وتقييم بالذكاء الاصطناعي",
          "سير عمل مخصصة بعلامتك التجارية",
          "مدير حساب مخصص",
          "وصول API وتكاملات",
          "أدوات تعاون الفريق",
        ],
      ...
      enterprise: {
        name: "المؤسسات",
        price: "مخصص",
        creditsAmount: "غير محدود",
        description: "حلول مخصصة للمؤسسات الكبيرة ذات الاحتياجات المعقدة.",
        features: [
          "أرصدة غير محدودة",
          "إعلانات وظيفية غير محدودة",
