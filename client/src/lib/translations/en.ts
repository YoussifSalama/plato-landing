export const en = {
  ...
  contactPage: {
    ...
    mapCard: {
      ...
      phone: "Tel: +202 333 65 804/6/7/8",
...
If you have questions about this Privacy Policy, please contact us at hello@platohiring.com.`,
  ...
  pricingPage: {
    title: "Pricing",
    subtitle: "Simple, transparent credit-based pricing. Pay only for what you use.",
    ...
    faqSubtitle: "Everything you need to know about our pricing and credits.",
    ctaTitle: "Ready to streamline",
    ctaTitleHighlight: "your hiring?",
    ctaSubtitle: "Start with a free trial and see how Plato transforms your recruitment process.",
    ...
    plans: {
      starter: {
        ...
        price: "$49",
        creditsAmount: "100",
        description: "Perfect for small teams just getting started with AI-powered hiring.",
        features: [
      ...
      pro: {
        ...
        price: "$349",
        creditsAmount: "1,500",
        description: "For established teams hiring at scale with full automation.",
        features: [
