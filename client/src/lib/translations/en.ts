export const en = {
  ...
  hero: {
    headline: "Hire faster with end-to-end screening and interview automation.",
    subheadline: "Plato turns resumes into a shortlist you can trust — with outreach, interviews, and structured reports built in.",
  ...
  employersPage: {
    ...
    heroSubtitle: "Plato automates screening, outreach, and interviews — so your team spends time on the candidates who matter most.",
    feature1Title: "Automated Resume Screening",
    feature1Desc: "Upload resumes in bulk. Plato parses, ranks, and shortlists candidates based on your criteria — in minutes.",
    feature2Title: "Outreach & Scheduling",
    feature2Desc: "Automated email and call outreach to shortlisted candidates, with built-in scheduling for interviews.",
    feature3Title: "Structured Interviews",
    feature3Desc: "Consistent, fair interviews with standardized questions and scoring. No more subjective gut-feels.",
    feature4Title: "Detailed Reports",
    feature4Desc: "Every candidate gets a structured evaluation report with explainable fit scores and interview summaries.",
    ctaTitle: "Start hiring smarter today",
    ctaSubtitle: "Book a demo and see Plato in action.",
  },
  jobSeekersPage: {
