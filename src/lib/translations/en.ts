export const en = {
  meta: {
    ...
    pages: {
      home: { title: "AI Hiring Platform for Faster Recruitment", description: "Plato is an AI hiring platform that automates CV screening, candidate outreach, and structured interviews to help teams hire faster with confidence." },
      employers: { title: "Recruitment Automation for Employers", description: "Scale hiring with AI-driven resume screening, structured interviews, and transparent candidate scoring built for modern talent teams." },
      jobSeekers: { title: "Job Matching Platform for Candidates", description: "Create your profile once, get matched to relevant jobs, and showcase your strengths through fair, structured interview workflows." },
      howItWorks: { title: "How Plato Hiring Automation Works", description: "See the end-to-end workflow: job setup, candidate screening, outreach, interviews, and actionable hiring reports in one platform." },
      blog: { title: "Hiring Insights & Recruitment Strategy Blog", description: "Explore practical hiring insights, recruiting playbooks, and AI recruitment trends from the Plato team." },
      faq: { title: "Hiring Platform FAQ", description: "Read answers about Plato features, setup, integrations, pricing, and recruitment automation best practices." },
      contact: { title: "Contact Plato Hiring Experts", description: "Talk with the Plato team about demos, onboarding, and support for your recruitment goals." },
      security: { title: "Security & Data Protection", description: "Learn how Plato secures hiring data with encryption, strict access controls, and privacy-first practices." },
      privacy: { title: "Privacy Policy", description: "Understand how Plato collects, processes, and protects candidate and employer data across the platform." },
      terms: { title: "Terms & Conditions", description: "Review the terms that govern your use of Plato's recruitment automation software and services." },
      pricing: { title: "Pricing Plans for Hiring Teams", description: "Compare Plato pricing plans and find the right recruitment automation package for your business." },
      bookDemo: { title: "Book a Demo", description: "Book a Plato demo to see how AI-powered candidate screening and interviews can improve hiring speed and quality." },
      login: { title: "Log In", description: "Securely log in to your Plato account for employer and candidate workflows." },
      signup: { title: "Create Your Plato Account", description: "Start your Plato account to launch faster hiring workflows with AI-powered screening and structured interviews." },
      testimonials: { title: "Customer Stories & Testimonials", description: "Read how teams use Plato to improve hiring quality, reduce time-to-hire, and make better recruitment decisions." },
    },
  },
  nav: {
  ...
  hero: {
    ...
    subheadline: "Plato helps recruitment teams automate candidate screening, run structured interviews, and shorten time-to-hire with transparent AI hiring workflows.",
  ...
  employersPage: {
    ...
    heroSubtitle: "Plato gives employers a complete recruitment automation stack: AI CV screening, smart shortlisting, interview workflows, and clear hiring reports.",
  ...
  jobSeekersPage: {
    ...
    heroSubtitle: "Build one profile, get matched to relevant roles faster, and prove your skills through fair, structured interviews.",
  ...
  contactPage: {
    title: "Contact Us",
    subtitle: "Need help with hiring automation, onboarding, or a tailored demo? The Plato team can guide your next hiring workflow and answer every product question.",
    infoCards: {
