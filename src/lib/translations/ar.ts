...
export const ar: typeof en = {
  meta: {
    ...
    pages: {
      home: { title: "منصة توظيف بالذكاء الاصطناعي لتوظيف أسرع", description: "بلاتو منصة توظيف ذكية تؤتمت فرز السير الذاتية والتواصل مع المرشحين والمقابلات المهيكلة لتسريع التوظيف ورفع جودة القرار." },
      employers: { title: "أتمتة التوظيف لأصحاب العمل", description: "طوّر عملية التوظيف عبر فرز ذكي للسير الذاتية ومقابلات مهيكلة وتقارير واضحة تساعد فرق التوظيف على الاختيار بثقة." },
      jobSeekers: { title: "منصة مطابقة وظائف للباحثين عن عمل", description: "أنشئ ملفك مرة واحدة واحصل على فرص مناسبة وأظهر نقاط قوتك عبر مقابلات عادلة ومنظمة." },
      howItWorks: { title: "كيف تعمل أتمتة التوظيف في بلاتو", description: "تعرّف على رحلة التوظيف كاملة: إعداد الوظيفة، فرز المرشحين، التواصل، المقابلات، وتقارير التوظيف في منصة واحدة." },
      blog: { title: "مدونة التوظيف ورؤى الموارد البشرية", description: "اطلع على استراتيجيات التوظيف الحديثة ونصائح عملية واتجاهات التوظيف بالذكاء الاصطناعي من فريق بلاتو." },
      faq: { title: "الأسئلة الشائعة عن منصة بلاتو", description: "اعثر على إجابات واضحة حول الميزات والتكاملات والأسعار وآلية تشغيل أتمتة التوظيف في بلاتو." },
      contact: { title: "تواصل مع خبراء بلاتو", description: "تواصل مع فريق بلاتو لحجز عرض تجريبي أو بدء الإعداد أو الحصول على دعم لمنظومة التوظيف لديك." },
      security: { title: "الأمان وحماية البيانات", description: "اكتشف كيف تحمي بلاتو بيانات التوظيف عبر التشفير وضوابط الوصول وممارسات خصوصية متقدمة." },
      privacy: { title: "سياسة الخصوصية", description: "تعرّف على كيفية جمع بلاتو لبيانات أصحاب العمل والمرشحين واستخدامها وحمايتها داخل المنصة." },
      terms: { title: "الشروط والأحكام", description: "راجع الشروط التي تنظم استخدامك لخدمات بلاتو في أتمتة التوظيف وإدارة الترشيح." },
      pricing: { title: "خطط الأسعار لفرق التوظيف", description: "قارن خطط أسعار بلاتو واختر الباقة الأنسب لتوسيع عمليات التوظيف وتحسين جودة الاختيار." },
      bookDemo: { title: "احجز عرضاً تجريبياً", description: "احجز ديمو بلاتو وشاهد كيف يرفع الذكاء الاصطناعي سرعة التوظيف وجودة تقييم المرشحين." },
      login: { title: "تسجيل الدخول", description: "سجّل الدخول بأمان إلى حساب بلاتو للوصول إلى سير عمل التوظيف للمرشحين وأصحاب العمل." },
      signup: { title: "أنشئ حسابك في بلاتو", description: "ابدأ حسابك في بلاتو لتفعيل أتمتة التوظيف عبر الفرز الذكي والمقابلات المهيكلة." },
      testimonials: { title: "قصص نجاح وآراء العملاء", description: "اكتشف كيف ساعدت بلاتو الفرق على تقليل وقت التوظيف وتحسين جودة الاختيار عبر تجارب واقعية." },
    },
  },
  nav: {
  ...
  hero: {
    ...
    subheadline: "بلاتو يساعد فرق التوظيف على أتمتة فرز المرشحين وإدارة المقابلات المهيكلة وتقليل وقت التوظيف عبر سير عمل واضح ومدعوم بالذكاء الاصطناعي.",
  ...
  employersPage: {
    heroTitle: "عن بلاتو",
    heroSubtitle: "يوفر بلاتو لأصحاب العمل منصة متكاملة لأتمتة التوظيف تشمل فرز السير الذاتية بالذكاء الاصطناعي، ترتيب المرشحين، إدارة المقابلات، وتقارير واضحة لاتخاذ القرار.",
  ...
  jobSeekersPage: {
    ...
    heroSubtitle: "أنشئ ملفك مرة واحدة، واحصل على فرص مناسبة أسرع، وأبرز مهاراتك عبر مقابلات عادلة ومهيكلة.",
  ...
  contactPage: {
    title: "تواصل معنا",
    subtitle: "هل تحتاج مساعدة في أتمتة التوظيف أو إعداد المنصة أو حجز عرض مخصص؟ فريق بلاتو جاهز لمساعدتك في بناء سير توظيف أسرع وأكثر دقة.",
    infoCards: {
